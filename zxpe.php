<!-- 以下代码为守护星空腐竹烧饼撰写并开源，模板套用的HTML5UP的HTML模板，在使用本程序时请保留版权信息，谢谢 -->
<?php
$serverIP = "45.125.46.134";// 修改此处的域名及端口为自己的即可
$port = "27008";
$iconlink = 'http://pms.vsc.icu/images/logo.jpg'; // 网站图标链接，可以使图片格式（.png/.jpg/etc.）或者是ico图标，用绝对路径或相对路径均可
$description = 'PixelMine服务器实时状态'; // 描述，会显示在大标题的下方，用html语法写就可以了，换行请用<br>
$imagelink = 'http://pms.vsc.icu/images/logo.jpg'; // 图片链接，会显示在服务器信息右边的圈圈里
								...
								<div class="spotlight">
									<div class="content">
										...
										<ul class="actions">
										    ...
										    <!-- 修改下方链接为自己的官网对应链接 -->
										<li><a href="http://pms.vsc.icu/index.html" class="button">主页</a></li>
										<li><a href="http://pms.vsc.icu/gonggao.html" class="button">公告</a></li>
										<li><a href="http://pms.vsc.icu/gl.html" class="button">管理组</a></li>
										</ul>
									</div>
