...
$host = "119.188.240.80"; //设置服务器域名或 IP
$port = "44441"; //设置服务器端口，可以直接用服务器的链接端口，也可以使用query端口（UDP协议）
$name = 'PixelMine Server'; // 服务器名字，会显示在标签页的标题和网站打头的大标题处
$iconlink = 'http://pixelmine.rainyun.prp/images/logo.jpg'; // 网站图标链接，可以使图片格式（.png/.jpg/etc.）或者是ico图标，用绝对路径或相对路径均可
$description = 'PixelMine Server'; // 描述，会显示在大标题的下方，用html语法写就可以了，换行请用<br>
$imagelink = 'http://pixelmine.rainyun.pro/images/logo.jpg'; // 图片链接，会显示在服务器信息右边的圈圈里
/*
$host = $_GET["host"];
$port = $_GET["port"];
							...
							<section id="intro" class="main">
								<div class="spotlight">
									<div class="content">
										...
										<ul class="actions">
										    <!-- 修改下方链接为自己的官网对应链接 -->
										<li><a href="http://pixelmine.rainyun.pro/" class="button">主页</a></li>
										<li><a href="http://pixelmine.rainyun.pro/gonggao.html" class="button">公告</a></li>
										<li><a href="http://pixelmine.rainyun.pro/gl.html" class="button">管理组</a></li>
										</ul>
									</div>
